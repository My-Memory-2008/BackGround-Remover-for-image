...
// Import a small vision model for subject enhancement
import { init, enhanceImage } from "https://cdn.skypack.dev/@vivym/subject-enhancer";
...
async function enhanceImageWithVision(imageBlob, prompt = "") {
    ...
    try {
        ...
        const enhancedImageData = await enhanceImage(visionModel, imageData, prompt);
